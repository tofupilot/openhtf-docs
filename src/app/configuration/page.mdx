...
You can manage test settings with configuration files. {{ className: 'lead' }}
...
You can load configurations from external files written in YAML format. For example:
