...
For more comprehensive examples and advanced measurement patterns, see the [callable decorators section](/measurements#callable-decorators) in the measurements documentation.
