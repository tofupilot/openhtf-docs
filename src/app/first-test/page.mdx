...
def main():
    ...
    test.execute(lambda: "SI051AB7B0001")   # Execute with DUT serial
...
This is the simplest OpenHTF test, running through the command line without the Operator UI. You'll learn to connect instruments, add measurements, and more in the next sections.
