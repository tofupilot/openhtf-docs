...
OpenHTF provides various logger options to capture and manage log output during test execution. This guide explains how to configure these logger options, including examples of adding log handlers to your script and sample log outputs.
