export const metadata = {
  title: 'Logger | TofuPilot',
  description: 'Explore how to configure logger options in OpenHTF to capture and manage log output during test execution, with examples of standard and custom log handlers.',
}
