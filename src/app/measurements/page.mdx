...
These values can be [numeric](#numeric), [boolean](#boolean), or [string](#boolean), and may be either simple or [multidimensional](#multidimensional). 
...
<Properties>
  ...
  <Property name="in_range(minimum, maximum)" type="Number (default=None)">
    Ensure the value is within the given range.
  </Property>
  <Property name="in_range(marginal_minimum, marginal_maximum)" type="Number (default=None)">
    Define a marginal measurement to obtain finer granularity of by how much a measurement is passing.
  </Property>
  <Property name="with_units(units)" type="UnitDescriptor (default=None)">
...
<Properties>
  <Property name="doc" type="string (default=None)">
    Add string describing the measurement.
  </Property>
  <Property name=".with_transform(fn)" type="function (default=None)">
    Apply a transformation function to modify the value before validation.
  </Property>
</Properties>
...
You can use boolean measurements to validate a condition, which  can be a boolean value, a number or a string.
...
<Properties>
  <Property name=".equals(value)" type="bool (default=None)">
    Ensures the measurement exactly matches the specified boolean value.
  </Property>
  <Property name=".with_units(unit)" type="UnitDescriptor (default=None)">
...
def main():
    test = htf.Test(check_firmware_version, check_board_temperature)
    test.execute(lambda: "SI051AB7B0001")
