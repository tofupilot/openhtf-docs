...
A `test_result.json` file is created after execution and saved in the execution directory. The file path can be changed if needed.

<Button href="/public/test_result.json" variant="text" arrow="right">
  <>Open example file</>
</Button>
...
<Button href="https//docs.tofupilot.com/uut" variant="text" arrow="right">
