...
OpenHTF supports various output formats to record test results, such as JSON and protobuf. This guide explains how to configure these formats, including examples of adding output callbacks to your script and sample output files. {{ className: 'lead' }}
