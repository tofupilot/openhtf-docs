...
export const metadata = {
  title: 'OpenHTF',
  description:
    'OpenHTF (Open Hardware Testing Framework) is the open-source Python hardware testing framework. Used by hundreds of teams worldwide, from labs to manufacturing floors for test automation, verification, and validation.',
  keywords: [
    ...defaultKeywords,
    'validation and verification',
    'manufacturing tests',
    'Google hardware testing',
    'TofuPilot integration',
  ],
  openGraph: {
    title:
      'OpenHTF Documentation - Open Source Hardware Testing Framework for Automated Hardware Testing',
    description:
      'OpenHTF is an open-source Python hardware testing framework used worldwide for hardware verification, validation, and manufacturing test automation,',
