export const metadata = {
  title: 'Instrument Plugs | TofuPilot',
  description:
    'Learn how to use OpenHTF’s plugin system to abstract hardware interactions, encapsulate reusable test logic, and manage configurations with examples of simple and configured plugs.',
}
...
<Image srcLight="/ykush.png" srcDark="/ykush.png" alt="YKUSH USB hub" />
