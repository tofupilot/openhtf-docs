export const metadata = {
  title: 'User Input | TofuPilot',
  description:
    'Learn how to enable test operator interaction with OpenHTF to handle scenarios where manual intervention or decision-making is involved.',
}
