...
Managing test results at scale often leads to missed failures and rework. **First-Pass Yield (FPY)** helps identify inefficiencies. TofuPilot automates FPY tracking and breaks it down by individual test steps. {{ className: 'lead' }}
