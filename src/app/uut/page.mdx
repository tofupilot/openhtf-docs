...
The <TofuPilotLink utmMedium="uut-integration" /> integration automatically uploads the OpenHTF report to your TofuPilot workspace.
...
def main():
    test = Test(get_sn)
    with TofuPilot(): # it's that simple :)
      test.execute()
