  ...
  return (
    <div className={cn('group relative p-[4px]', containerClassName)}>
      <motion.div
        ...
        className={cn(
          'absolute inset-0 z-[1] rounded-3xl opacity-40 blur-md transition duration-500 will-change-transform group-hover:opacity-100 group-hover:blur-lg',
...
export function TofuPilotBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 select-none px-4 pb-4">
      <div className="block h-[144px]">
        <BackgroundGradient className="mx-auto w-[280px] rounded-[22px] bg-white p-4 ring-1 ring-inset ring-zinc-900/7.5 dark:bg-zinc-900">
